        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a href="" class="navbar-brand">
                    <img src="${pageContext.request.contextPath}/images/timg.jpg" align="left" width="40"/>持名法州后台管理系统 v1.0
                </a>
            </div>
            <%--内容--%>
            ...
            <%--   右边轮播图 --%>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h1><span class="glyphicon glyphicon-heart" aria-hidden="true">
                            &nbsp;
                        </span>欢迎来到持明法洲后台管理系统</h1>
                    </div>
                </div>
